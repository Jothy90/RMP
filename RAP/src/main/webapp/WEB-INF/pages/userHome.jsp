...
<head>
    ...
    <title>RMP User: <c:out value="${sessionScope.userName}"/></title>
    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li class="active"><a href="#"><c:out value="${sessionScope.userName}"/> home</a></li>
            </ul>
    ...
    <div class="row">
        <div class="col-sm-2 col-sm-offset-10">
            <form action="addDevice" method="get">
                ...
                <button style="margin:5%" type="submit" class="btn btn-lg btn-success col-sm-12">Add Another Device
                </button>
            </form>
        </div>
    </div>
